...
def Blast_Run( data   ):
    ...
    os.system( command )
    raw_result = open( queue_output+ "_1.1c_2.3_s1_0_16_1",'rU').read()

    new_result = raw_result.split("""//****************************************//
...
genBlast""")[0]
    END = open(queue_output,'w')
    END.write(new_result)
    END.close()
    os.remove(queue_output+ "_1.1c_2.3_s1_0_16_1" )
