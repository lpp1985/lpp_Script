...
def circle_new(gc_view)  :
	...
	draw.ellipse((50, 50, r2-50, r2-50), fill=255)
...
def ring_new(gene_view):
	...
	draw = ImageDraw.Draw(circle)
	draw.ellipse((500, 450, 1500, 1500), fill=0)
...
'''
	...
	END.close()
	command = "java -jar %s/gview.jar -t 100 -i %s -o ring.png -l circular -W 2000 -H 2000 -q high -f png"%(gview_root,END.name  )
	subprocess.check_output(command.split())
	command ="java -jar %s/gview.jar -t 100 -i %s -s %s -o circle.png -l circular  -W 1200 -H 1200 -q high -f png" %(gview_root,gbk,gview_root+'/myown.gss')
	subprocess.check_output(command.split())
	...
	new_img.paste(gc_graph,(400,400),mask=gc_graph)
