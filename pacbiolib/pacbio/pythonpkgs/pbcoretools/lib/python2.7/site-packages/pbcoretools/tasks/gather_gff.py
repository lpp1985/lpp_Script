...
from pbcoretools.chunking.gather import run_main_gather_gff

log = logging.getLogger(__name__)


class Constants(object):
    TOOL_ID = "pbcoretools.tasks.gather_gff"
    CHUNK_KEY = "$chunk.gff_id"
    VERSION = "0.1.0"
    DRIVER = "python -m pbcoretools.tasks.gather_gff --resolved-tool-contract "
    OPT_CHUNK_KEY = '"pbcoretools.task_options.gff_gather_chunk_key"'
